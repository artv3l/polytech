...
/*..........................................................................*/
/*п р о т о т и п  обращ.к*/
int FRS(); /*подпр.обр.опер.RS-форм. */
/*..........................................................................*/
...
struct OPRS /*структ.буф.опер.форм.RS */
{
    unsigned char OP;   /*код операции            */
    unsigned char R1R3;
    short B2D2;
...
union /*определить об'единение  */
{
    unsigned char BUF_OP_RS[4]; /*оределить буфер         */
    struct OPRS OP_RS;          /*структурировать его     */
} RS;
  ...
  {                                                     /*то:                     */
    ...
    if                                                  /* если псевдооперация DC */
        (                                               /* определяет константу   */
         operand[0] == 'F' /* типа F, то выполнить   */
         )                                              /* следующее:             */
    {
...
int SRS() /*подпр.обр.опер.RS-форм. */
{
    ...
    unsigned char R1R3;                                /*                        */
    int B2D2;                                          /*                        */
    RS.OP_RS.OP = T_MOP[I3].CODOP;                     /*формирование кода операц*/
    METKA1 = strtok                                    /*в перем. c указат.METKA1*/
    (                                              /*выбираем первую лексему */
     (char*)TEK_ISX_KARTA.STRUCT_BUFCARD.OPERAND, /*операнда текущей карты  */
     ","                                           /*исх.текста АССЕМБЛЕРА   */
    ...
    {                              /*с буквы, то:            */
        ...
        {                            /* табл. T_SYM сравниваем */
          /* со знач.перем. *METKA  */
            ...
            {                             /*  берем значение этой   */
                R1R3 = T_SYM[J].ZNSYM << 4; /*  метки в качестве перв.*/
                goto SRS1;
            } /*  опреранда машинной ком*/
        }
        return (2); /*сообщ."необ'явл.идентиф"*/
    ...
    {                           /*перв.операнда машинн.ком*/
        R1R3 = atoi(METKA1) << 4; /*значен.выбр.   лексемы  */
    }
...
SRX2:
    ...
    RS.OP_RS.R1R3 = R1R3; /*дозапись перв.операнда  */
    RS.OP_RS.B2D2 = B2D2;
